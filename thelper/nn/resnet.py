...
class ResNet(thelper.nn.Module):
    ...
    def __init__(self, task, block="thelper.nn.resnet.BasicBlock",
                 ...
                 flexible_input_res=False, conv1_kernel_size=7, conv1_stride=2,
                 pool_size=7, head_type=None, coordconv=False, radius_channel=True,
                 activation="relu", skip_max_pool=False, pretrained=False):
